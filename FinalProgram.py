...
def detect_foot(image_path):
    ...
    try:
        ...
        if contours:
            ...
            aspect_ratio = h / w
            area = w * h
            if 0.5 < aspect_ratio < 3.0 and area > 500:  # Example thresholds for a foot
                return x, y, w, h
            else:
                print("Invalid object detected. Likely not a foot.")
                return None
        else:
...
image_path = "/home/axg1503/CSDS451/Project/ai3/sample_image11.jpg"  
try:
    ...
    if bounding_box:
        ...
        output_path = "/home/axg1503/CSDS451/Project/ai3/detected_foot.jpg"
        cv2.imwrite(output_path, image)  # Save the image with bounding box
        ...
        print("Foot detection failed. Please use a valid foot image.")
